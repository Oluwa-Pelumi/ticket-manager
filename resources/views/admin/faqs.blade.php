            ...
            <form method="POST" action="{{ route('admin.faqs.store') }}" x-show="!faq" class="space-y-8" @submit="processing = true">
                ...
                <div class="space-y-3">
                    ...
                    <input type="text" name="question" x-model="question"
                        class="w-full px-6 py-4 rounded-2xl bg-slate-50 dark:bg-[#1e293b] border-sky-950/10 dark:border-[#28524a] focus:ring-2 focus:ring-sky-400 transition-all font-bold dark:text-white"
                ...
                <div class="space-y-3">
                    ...
                    <textarea name="answer" x-model="answer"
                        class="w-full px-6 py-4 rounded-2xl bg-slate-50 dark:bg-[#1e293b] border-sky-950/10 dark:border-[#28524a] focus:ring-2 focus:ring-sky-400 transition-all font-medium dark:text-white min-h-[150px]"
                ...
                <div class="space-y-3">
                    ...
                    <input type="number" name="order" x-model="order"
                        class="w-full px-6 py-4 rounded-2xl bg-slate-50 dark:bg-[#1e293b] border-sky-950/10 dark:border-[#28524a] focus:ring-2 focus:ring-sky-400 transition-all font-black dark:text-white" />
                </div>

                ...
                <div>
                    ...
                    <div class="fauna-panel p-6 md:p-8 relative overflow-hidden">
                        ...
                        <div class="flex items-center gap-3 mb-8 group/id">
                            <div
                                class="text-xl md:text-2xl text-slate-900 dark:text-white font-black tracking-tight break-all">
                                {{ $ticket->hashid }}</div>
                        ...
                        <div class="mb-6">
                            <span
                                class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] md:text-xs font-black tracking-wider
                        ...
                        @if ($ticket->order_type)
                            <div class="mt-6">
                                <div class="text-[10px] font-black text-slate-400 mb-2 uppercase tracking-widest">
                                ...
                                <div class="space-y-1.5">
                                    @if ($ticket->order_activations !== null)
                                        @foreach ($ticket->order_activations as $date)
                                            <div
                                                class="text-[11px] font-medium text-slate-600 dark:text-slate-400 flex items-center gap-2">
                                                <div class="w-1 h-1 rounded-full bg-lime-500 shrink-0">
                                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center space-x-2 mb-2">
                                            ...
                                            @if ($comment->user && ($comment->user->role === 'support' || $comment->user->role === 'admin'))
                                                <span
                                                    class="px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider rounded {{ $isSelf ? 'bg-white/20 text-white' : 'bg-sky-500/20 text-sky-900 dark:bg-sky-400/20 dark:text-sky-400' }}">Support</span>
                                            @endif
                                            <span
                        ...
                        <form method="POST" action="{{ route('add-comment', ['ticket' => $ticket->id]) }}"
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    ...
                                    {{-- Submit --}}
                                    <button type="submit"
                                        x-bind:disabled="processing || isPastAttendant || !content.trim()"

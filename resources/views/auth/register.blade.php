...
<form method="POST" action="{{ route('register') }}" class="space-y-5" x-data="{ processing: false }" x-init="$nextTick(() => { const el = document.getElementById('name'); if(el) { el.focus(); } })" @submit="processing = true">
    @csrf

...
<<<<<<< HEAD
                ...
                <div x-show="submitted" x-cloak class="py-12 flex flex-col items-center text-center space-y-6">
                    ...
                    <div class="px-6 py-4 rounded-2xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-900/50 space-y-1">
                        <div class="text-[10px] font-black tracking-widest text-emerald-950 dark:text-emerald-400 uppercase">Reference Code</div>
                        <div class="flex items-center justify-center gap-2">
                            <div class="text-2xl font-black tracking-widest text-emerald-950 dark:text-white" x-text="ticketRef"></div>
                            ...
                            " class="p-2 rounded-lg bg-emerald-200 dark:bg-emerald-800/50 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-300 dark:hover:bg-emerald-700 transition-all" title="Copy Reference Code">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 w-full max-w-sm">
                        ...
                        <button type="button"
                            ...
                            class="flex-1 px-5 py-3 rounded-2xl border border-emerald-950/20 dark:border-[#1e3a5f] text-slate-600 dark:text-slate-400 font-black text-sm hover:bg-slate-50 dark:hover:bg-[#1e293b] transition-all">
                            Submit Another
                        </button>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:col-span-2">
                        ...
                        <div class="space-y-3">
                            ...
                            <input
                                ...
                                class="w-full px-5 py-4 rounded-2xl bg-white dark:bg-[#1e293b] border text-slate-900 dark:text-white focus:ring-2 transition-all outline-none font-medium shadow-sm disabled:opacity-50 disabled:bg-slate-100 disabled:dark:bg-[#0f172a] @error('first_name') border-red-500 dark:border-red-500 focus:border-red-500 focus:ring-red-500 @else border-slate-200 dark:border-[#1e3a5f] focus:ring-slate-400 @enderror"
                        ...
                        <div class="space-y-3">
                            ...
                            <input
                                ...
                                class="w-full px-5 py-4 rounded-2xl bg-white dark:bg-[#1e293b] border text-slate-900 dark:text-white focus:ring-2 transition-all outline-none font-medium shadow-sm disabled:opacity-50 disabled:bg-slate-100 disabled:dark:bg-[#0f172a] @error('middle_name') border-red-500 dark:border-red-500 focus:border-red-500 focus:ring-red-500 @else border-slate-200 dark:border-[#1e3a5f] focus:ring-slate-400 @enderror"
                        ...
                        <div class="space-y-3">
                            ...
                            <input
                                ...
                                class="w-full px-5 py-4 rounded-2xl bg-white dark:bg-[#1e293b] border text-slate-900 dark:text-white focus:ring-2 transition-all outline-none font-medium shadow-sm disabled:opacity-50 disabled:bg-slate-100 disabled:dark:bg-[#0f172a] @error('last_name') border-red-500 dark:border-red-500 focus:border-red-500 focus:ring-red-500 @else border-slate-200 dark:border-[#1e3a5f] focus:ring-slate-400 @enderror"

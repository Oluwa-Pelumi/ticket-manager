            ...
            >
                ...
                <div x-show="!submitted" class="space-y-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <div x-data="{
                            countryCode: '+234',
                            localPhone: '{{ old('phone_number', $user->phone_number ? preg_replace('/^\+\d+/', '', $user->phone_number) : '') }}',
                            countryCodes: [
                                { code: '+1',   name: 'US/CA +1' },  { code: '+7',   name: 'RU +7' },
                                { code: '+20',  name: 'EG +20' },    { code: '+27',  name: 'ZA +27' },
                                { code: '+30',  name: 'GR +30' },    { code: '+31',  name: 'NL +31' },
                                { code: '+32',  name: 'BE +32' },    { code: '+33',  name: 'FR +33' },
                                { code: '+34',  name: 'ES +34' },    { code: '+36',  name: 'HU +36' },
                                { code: '+39',  name: 'IT +39' },    { code: '+40',  name: 'RO +40' },
                                { code: '+41',  name: 'CH +41' },    { code: '+44',  name: 'GB +44' },
                                { code: '+49',  name: 'DE +49' },    { code: '+55',  name: 'BR +55' },
                                { code: '+61',  name: 'AU +61' },    { code: '+62',  name: 'ID +62' },
                                { code: '+63',  name: 'PH +63' },    { code: '+65',  name: 'SG +65' },
                                { code: '+81',  name: 'JP +81' },    { code: '+82',  name: 'KR +82' },
                                { code: '+86',  name: 'CN +86' },    { code: '+90',  name: 'TR +90' },
                                { code: '+91',  name: 'IN +91' },    { code: '+92',  name: 'PK +92' },
                                { code: '+94',  name: 'LK +94' },    { code: '+212', name: 'MA +212' },
                                { code: '+213', name: 'DZ +213' },   { code: '+216', name: 'TN +216' },
                                ...
                                { code: '+249', name: 'SD +249' },   { code: '+250', name: 'RW +250' },
                                { code: '+251', name: 'ET +251' },   { code: '+254', name: 'KE +254' },
                                { code: '+255', name: 'TZ +255' },   { code: '+256', name: 'UG +256' },
                                { code: '+260', name: 'ZM +260' },   { code: '+263', name: 'ZW +263' },
                                { code: '+966', name: 'SA +966' },   { code: '+971', name: 'AE +971' },
                                { code: '+234', name: 'NG +234' },
                            ]
                        }"
                        class="flex rounded-2xl overflow-hidden border shadow-sm @if($user->phone_number) opacity-50 bg-slate-100 dark:bg-[#0f172a] pointer-events-none @else bg-white dark:bg-[#1e293b] @endif transition-all @error('phone_number') border-rose-500 dark:border-rose-500 @else border-slate-200 dark:border-[#1e3a5f] @enderror focus-within:ring-2 focus-within:ring-rose-400">
                            <select
                                x-model="countryCode"
                                class="shrink-0 px-3 py-4 bg-slate-50 dark:bg-[#1e293b]/50 text-slate-600 dark:text-slate-400 font-bold text-sm border-0 border-r border-slate-200 dark:border-[#1e3a5f] outline-none cursor-pointer"

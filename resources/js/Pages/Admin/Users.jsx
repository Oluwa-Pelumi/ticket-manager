                                                ...
                                                <div className="flex flex-col items-end gap-2">
                                                    <div className="flex items-center space-x-2">
                                                        <select
                                                            ...
                                                            className="text-xs font-bold bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg focus:ring-[#FF2D20] disabled:opacity-50 transition-all cursor-pointer"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            disabled={user.id === auth.user.id || processing}
                                                            className="p-2 bg-rose-500/10 text-rose-500 hover:bg-rose-500 hover:text-white rounded-lg transition-all disabled:opacity-50 shadow-sm"
                                                            title="Delete User"
                                                        >
                                                    ...
                                                    {user.id === auth.user.id && (
                                                        <div className="text-[10px] text-slate-400 uppercase font-bold">Current Session</div>
                                                    )}
                                                </div>
                                            </td>
                                        </tr>

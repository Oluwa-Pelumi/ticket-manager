                        ...
                        <div className="fauna-panel p-6 sm:p-8 lg:sticky lg:top-24">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-2">
                                    <label className="text-xs font-black tracking-widest text-slate-600 dark:text-slate-400">
                                        Category Name
                                    </label>
                                    <input
                                        disabled={processing}
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="border-b border-emerald-900/10 dark:border-[#1d3a34]">
                                        <th className="px-6 py-4 text-[10px] font-black tracking-widest text-slate-600 dark:text-slate-400">
                                            Category Details
                                        </th>
                                        <th className="px-6 py-4 text-[10px] font-black tracking-widest text-slate-600 dark:text-slate-400">
                                            Group
                                        </th>
                                        <th className="px-6 py-4 text-[10px] font-black tracking-widest text-slate-600 dark:text-slate-400 text-right">
                                            Actions
                                        </th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                                    {categories.map((category) => (
                                        <tr
                                            key={category.id}
                                            className="hover:bg-emerald-50/50 dark:hover:bg-[#18342f]/70 transition-colors"
                                        >
                                            ...
                                            <td className="px-6 py-5">
                                                {category.group ? (
                                                    <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-black tracking-widest bg-lime-500/10 text-teal-900 dark:text-lime-400">
                                                        {category.group}
                                                    </span>
                                                ) : (
                                                    <span className="text-[10px] font-black text-slate-300 dark:text-slate-700 italic tracking-widest">
                                                        No Group
                                                    </span>
                                                )}
                                            </td>

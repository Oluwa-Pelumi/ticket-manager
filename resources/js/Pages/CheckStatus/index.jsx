                                ...
                                <div className="space-y-4">
                                    {tickets.map((ticket) => (
                                        <Link
                                            ...
                                            className="block p-6 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md hover:border-[#FF2D20]/50 transition-all group"
                                        >
                                            <div className="flex justify-between items-start mb-4">
                                                <div>
                                                    <div className="text-xs font-black text-[#FF2D20] uppercase tracking-wider mb-1">
                                                        #{ticket.id.substring(0, 8)}...
                                                    </div>
                                                    <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-[#FF2D20] transition-colors">
                                            ...
                                            <div className="flex items-center justify-between text-xs text-slate-500">
                                                ...
                                                <div className="flex items-center text-[#FF2D20] font-bold group-hover:translate-x-1 transition-transform">
                                                    View Details 

            ...
            <div className="fauna-shell relative min-h-screen flex flex-col items-center overflow-x-hidden transition-colors duration-500 selection:bg-lime-500 selection:text-teal-900">
                    ...
                    <div className="max-w-7xl mx-auto flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="hidden sm:flex items-center gap-1 p-1 bg-slate-200/40 dark:bg-[#18342f]/40 rounded-2xl border border-emerald-900/20 dark:border-[#1d3a34]/50 backdrop-blur-md">
                                <Link
                                    href={route("home")}
                                    className="inline-flex items-center px-4 py-2 text-[10px] font-black tracking-widest transition duration-200 ease-in-out rounded-xl text-slate-600 dark:text-slate-400 hover:text-teal-900 hover:bg-slate-300/20 dark:hover:bg-slate-700/20"
                                >
                                    Home
                                </Link>
                ...
                <div className="relative z-10 w-full max-w-3xl mx-auto px-6 pt-20 pb-16">
                    ...
                    <div className="text-center mb-10">
                        <Link
                            href={route("home")}
                            className="inline-flex items-center text-xs md:text-sm font-semibold text-slate-600 dark:text-slate-400 hover:text-teal-900 transition-colors mb-4 tracking-widest"
                        >
                            <svg
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-3">
                                <label
                                    className="text-xs font-bold tracking-widest text-slate-600 dark:text-slate-400 ml-1"
                                    htmlFor="name"
                                >
                                    Name *
                                </label>
                        ...
                        <div className="space-y-3">
                                ...
                                {Object.entries(groupedCategories).map(
                                    ([groupLabel, items]) => (
                                        <optgroup
                                            key={groupLabel}
                                            label={groupLabel}
                                            className="font-bold text-teal-900 dark:text-lime-400"
                                        >
                                            {items.map((sub, idx) => {
                                                const isDisabled =
                                                    !auth.user &&
                            ...
                            {categories.length === 0 && (
                                <div className="text-amber-500 text-xs mt-1 font-semibold">
                                    Support categories are currently
                                    unavailable. You cannot submit a ticket
                                    right now.
                                </div>
                            )}
                            {errors.subject && (
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                            {[
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <span className="text-[10px] font-black tracking-tight uppercase text-center">
                                                        {period.label}
                                                    </span>
                                                </label>
                                            ))}
                        ...
                        <div className="space-y-4">
                            <label className="text-xs font-bold tracking-widest text-slate-600 dark:text-slate-400 ml-1 block">
                                Attachments
                            </label>
                            <div className="relative group/upload">
                                ...
                                >
                                    ...
                                    <span className="text-slate-600 text-xs mt-1">
                                        PNG, JPG up to 5MB each. Drag and drop
                                        supported.
                                    </span>
                                </label>
                            </div>
                            ...
                            {previewUrls.length > 0 && (
                                <div className="mt-6 animate-in fade-in zoom-in duration-500">
                                    <div className="text-[10px] font-black text-teal-900 dark:text-lime-400 mb-4 tracking-[0.2em]">
                                        Ready for Ticket ({previewUrls.length})
                                    </div>

    ...
    public function run(): void
    {
        ...
        $tickets = [
            ...
            [
                ...
                'category_id'     => $transcript?->id,
                'subject'         => 'transcript-request',
                'content'         => 'Does the official transcript package provided for the 2019 Civil Engineering curriculum contain the accreditation status? I need this for my visa application.',
                'priority'        => 'low',
                'status'          => 'resolved',
                'attended_to_by'  => $support2?->id,
            ],

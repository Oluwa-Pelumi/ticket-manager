    ...
    public function run(): void
    {
        ...
        $tickets = [
            ...
            [
                ...
                'subject'         => 'Urgent Undergraduate Transcript Request',
            ...
            [
                ...
                'subject'         => 'Syllabus Copy for Year 3 Courses',
            ...
            [
                ...
                'subject'         => 'Recommendation Letter Request - Dr. Adewale',
            ...
            [
                ...
                'subject'         => 'B.Sc. Degree Certificate Collection',
            ...
            [
                ...
                'subject'         => 'Statement of Result Status Update',
            ...
            [
                ...
                'category_id'     => $transcript?->id,
                'subject'         => 'Official Transcript for WES Evaluation',
            ...
            [
                ...
                'phone_number' => '+2348000000005',
                'category_id'     => $certificate?->id,
                'subject'         => 'Bulk Certificate Requests for Alumni Group',
            ...
            [
                ...
                'phone_number' => '+2348000000005',
                'category_id'     => $syllabus?->id,
                'subject'         => 'Detailed Syllabus for Chemistry Department',
            ...
            [
                ...
                'phone_number' => '+2348000000005',
                'category_id'     => $recommendation?->id,
                'subject'         => 'Academic Reference Letter Status',
            ...
            [
                ...
                'phone_number' => '+2348000000005',
                'category_id'     => $statement?->id,
                'subject'         => 'Statement of Result Copy Request',
            ...
            [
                ...
                'subject'         => 'Alumni Verification Request',
            ...
            [
                ...
                'category_id'     => $certificate?->id,
                'subject'         => 'Replacement of Damaged Degree Certificate',
            ...
            [
                ...
                'category_id'     => $recommendation?->id,
                'subject'         => 'Reference for Postgrad Studies Abroad',
            ...
            [
                ...
                'category_id'     => $syllabus?->id,
                'subject'         => 'Engineering Syllabus Accreditation Query',
            ...
            [
                ...
                'category_id'     => $statement?->id,
                'subject'         => 'Urgent Statement of Result for NYSC',
            ...
            [
                ...
                'category_id'     => $transcript?->id,
                'subject'         => 'Transcript Dispatched to Local University',
            ...
            [
                ...
                'category_id'     => $other?->id,
                'subject'         => 'Correction of Name on Portal',
            ...
            [
                ...
                'category_id'     => $certificate?->id,
                'subject'         => 'Postgraduate Diploma Certificate Issue',
            ...
            [
                ...
                'category_id'     => $recommendation?->id,
                'subject'         => 'Recommendation from Vice Chancellor',
            ...
            [
                ...
                'category_id'     => $syllabus?->id,
                'subject'         => 'Course Description Booklet Request',

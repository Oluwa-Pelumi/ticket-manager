    ...
    public function run(): void
    {
        ...
        $tickets = [
            ...
            [
                ...
                'subject'         => 'Monthly Metformin Refill Request',
            ...
            [
                ...
                'subject'         => 'Lisinopril Dosage Enquiry',
            ...
            [
                ...
                'subject'         => 'Seeking Advice on Medication Interactions',
            ...
            [
                ...
                'whatsapp_number' => '+2348000000004',
                'category_id'     => $order?->id,
                'subject'         => 'Amlodipine Weekly Order',
            ...
            [
                ...
                'whatsapp_number' => '+2348000000004',
                'category_id'     => $enquiry?->id,
                'subject'         => 'Delivery Status for Last Order',
            ...
            [
                ...
                'category_id'     => $consult?->id,
                'subject'         => 'Amoxicillin for Dental Infection',
            ...
            [
                ...
                'whatsapp_number' => '+2348000000005',
                'category_id'     => $order?->id,
                'subject'         => 'Paracetamol Bulk Order for Family',
            ...
            [
                ...
                'whatsapp_number' => '+2348000000005',
                'category_id'     => $enquiry?->id,
                'subject'         => 'Storage Requirements for Insulin',
            ...
            [
                ...
                'whatsapp_number' => '+2348000000005',
                'category_id'     => $consult?->id,
                'subject'         => 'Safe Analgesics During Pregnancy',
            ...
            [
                ...
                'whatsapp_number' => '+2348000000005',
                'category_id'     => $order?->id,
                'subject'         => 'Iron Supplement Subscription',
            ...
            [
                ...
                'category_id'     => $enquiry?->id,
                'subject'         => 'Availability of Ciprofibrate',
            ...
            [
                ...
                'category_id'     => $order?->id,
                'subject'         => 'Urgent Insulin Glargine Order',
            ...
            [
                ...
                'category_id'     => $consult?->id,
                'subject'         => 'Mixing Herbal Remedies with Warfarin',
            ...
            [
                ...
                'category_id'     => $enquiry?->id,
                'subject'         => 'Prescription Validity Period',
            ...
            [
                ...
                'category_id'     => $order?->id,
                'subject'         => 'Omeprazole Quarterly Supply',
            ...
            [
                ...
                'category_id'     => $consult?->id,
                'subject'         => 'Antibiotic Resistance Concern',
            ...
            [
                ...
                'category_id'     => $enquiry?->id,
                'subject'         => 'Generic vs Brand Medication Query',
            ...
            [
                ...
                'category_id'     => $order?->id,
                'subject'         => 'Child Vitamin D Drops – Monthly Order',
            ...
            [
                ...
                'category_id'     => $consult?->id,
                'subject'         => 'Post-Surgical Pain Management',
            ...
            [
                ...
                'category_id'     => $enquiry?->id,
                'subject'         => 'Blood Pressure Monitor Recommendation',
